...
<script type="text/javascript">
	...
	function insert_form() {
		...
		//글쓰기 폼으로 이동
		location.href="qna_insert_form.do"; // /board/insert_form.do
	}//end:insert_form()
	...
	function find() {
		...
		location.href="qna_list.do?category=" + search + 
				...
				<tr>
					...
					<td class="b_subject" >
						...
						<c:if test="${ vo.b_use eq 'y' }">
							 <a href="view.do?b_idx=${ vo.b_idx }&page=${ empty param.page ? 1 : param.page }&search=${ param.search }&community_page=3&">${ vo.b_subject }</a>
						
						<!-- badge: 댓글갯수 -->
							<c:if test="${ vo.cmt_count gt 0 }">
		              	    	<span class="badge" style="background: #FFB6C1;"> <a class="commentFocus"  href="view.do?b_idx=${ vo.b_idx }&page=${ empty param.page ? 1 : param.page }&search=${ param.search }&community_page=3&commentFocus=true">${ vo.cmt_count }</a></span>
		              	 	</c:if>
